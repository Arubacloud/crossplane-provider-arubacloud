...
**Steps**:
1. Clone `upjet-provider-template` → new repo `crossplane-provider-arubacloud`
2. Run `./hack/prepare.sh` with provider name `arubacloud` and module `github.com/arubacloud/crossplane-provider-arubacloud`
