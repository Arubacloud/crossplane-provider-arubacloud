...
import (
	...
	apisCluster "github.com/arubacloud/crossplane-provider-arubacloud/apis/cluster"
	apisNamespaced "github.com/arubacloud/crossplane-provider-arubacloud/apis/namespaced"
	"github.com/arubacloud/crossplane-provider-arubacloud/config"
	"github.com/arubacloud/crossplane-provider-arubacloud/internal/clients"
	controllerCluster "github.com/arubacloud/crossplane-provider-arubacloud/internal/controller/cluster"
	controllerNamespaced "github.com/arubacloud/crossplane-provider-arubacloud/internal/controller/namespaced"
	"github.com/arubacloud/crossplane-provider-arubacloud/internal/features"
	"github.com/arubacloud/crossplane-provider-arubacloud/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped ArubaCloud APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced ArubaCloud APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped ArubaCloud controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced ArubaCloud controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped ArubaCloud controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced ArubaCloud controllers")
	}
