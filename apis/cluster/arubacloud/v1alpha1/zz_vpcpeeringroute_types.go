...
type VpcpeeringrouteInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/arubacloud/crossplane-provider-arubacloud/apis/cluster/arubacloud/v1alpha1.Vpcpeering
	...
	// +kubebuilder:validation:Optional
	VPCPeeringIDRef *v2.Reference `json:"vpcPeeringIdRef,omitempty" tf:"-"`

	// Selector for a Vpcpeering in arubacloud to populate vpcPeeringId.
	// +kubebuilder:validation:Optional
	VPCPeeringIDSelector *v2.Selector `json:"vpcPeeringIdSelector,omitempty" tf:"-"`
}
