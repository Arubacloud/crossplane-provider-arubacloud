...
type ContainerregistryNetworkInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	PublicIPURIRefRef *v2.Reference `json:"publicIpUriRefRef,omitempty" tf:"-"`

	// Selector for a Elasticip in arubacloud to populate publicIpUriRef.
	// +kubebuilder:validation:Optional
	PublicIPURIRefSelector *v2.Selector `json:"publicIpUriRefSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SecurityGroupURIRefRef *v2.Reference `json:"securityGroupUriRefRef,omitempty" tf:"-"`

	// Selector for a Securitygroup in arubacloud to populate securityGroupUriRef.
	// +kubebuilder:validation:Optional
	SecurityGroupURIRefSelector *v2.Selector `json:"securityGroupUriRefSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SubnetURIRefRef *v2.Reference `json:"subnetUriRefRef,omitempty" tf:"-"`

	// Selector for a Subnet in arubacloud to populate subnetUriRef.
	// +kubebuilder:validation:Optional
	SubnetURIRefSelector *v2.Selector `json:"subnetUriRefSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	VPCURIRefRef *v2.Reference `json:"vpcUriRefRef,omitempty" tf:"-"`

	// Selector for a VPC in arubacloud to populate vpcUriRef.
	// +kubebuilder:validation:Optional
	VPCURIRefSelector *v2.Selector `json:"vpcUriRefSelector,omitempty" tf:"-"`
}
...
type ContainerregistryStorageInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	BlockStorageURIRefRef *v2.Reference `json:"blockStorageUriRefRef,omitempty" tf:"-"`

	// Selector for a Blockstorage in arubacloud to populate blockStorageUriRef.
	// +kubebuilder:validation:Optional
	BlockStorageURIRefSelector *v2.Selector `json:"blockStorageUriRefSelector,omitempty" tf:"-"`
}
