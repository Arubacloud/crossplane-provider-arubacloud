...
type NetworkInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ElasticIPURIRefRef *v2.Reference `json:"elasticIpUriRefRef,omitempty" tf:"-"`

	// Selector for a Elasticip in arubacloud to populate elasticIpUriRef.
	// +kubebuilder:validation:Optional
	ElasticIPURIRefSelector *v2.Selector `json:"elasticIpUriRefSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SecuritygroupURIRefsRefs []v2.Reference `json:"securitygroupUriRefsRefs,omitempty" tf:"-"`

	// Selector for a list of Securitygroup in arubacloud to populate securitygroupUriRefs.
	// +kubebuilder:validation:Optional
	SecuritygroupURIRefsSelector *v2.Selector `json:"securitygroupUriRefsSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SubnetURIRefsRefs []v2.Reference `json:"subnetUriRefsRefs,omitempty" tf:"-"`

	// Selector for a list of Subnet in arubacloud to populate subnetUriRefs.
	// +kubebuilder:validation:Optional
	SubnetURIRefsSelector *v2.Selector `json:"subnetUriRefsSelector,omitempty" tf:"-"`
...
type SettingsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/arubacloud/crossplane-provider-arubacloud/apis/cluster/arubacloud/v1alpha1.Keypair
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("uri",true)
	...
	// +kubebuilder:validation:Optional
	KeyPairURIRefRef *v2.Reference `json:"keyPairUriRefRef,omitempty" tf:"-"`

	// Selector for a Keypair in arubacloud to populate keyPairUriRef.
	// +kubebuilder:validation:Optional
	KeyPairURIRefSelector *v2.Selector `json:"keyPairUriRefSelector,omitempty" tf:"-"`
	...
	UserDataSecretRef *v2.SecretKeySelector `json:"userDataSecretRef,omitempty" tf:"-"`
}
...
type StorageInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	BootVolumeURIRefRef *v2.Reference `json:"bootVolumeUriRefRef,omitempty" tf:"-"`

	// Selector for a Blockstorage in arubacloud to populate bootVolumeUriRef.
	// +kubebuilder:validation:Optional
	BootVolumeURIRefSelector *v2.Selector `json:"bootVolumeUriRefSelector,omitempty" tf:"-"`
}
