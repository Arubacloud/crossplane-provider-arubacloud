...
`crossplane-provider-arubacloud` is a [Crossplane](https://crossplane.io/) provider built with [Upjet](https://github.com/crossplane/upjet) that exposes XRM-conformant managed resources for the [ArubaCloud](https://www.cloud.it/) API.
...
```bash
crossplane xpkg install provider xpkg.upbound.io/arubacloud/crossplane-provider-arubacloud:v0.1.0
```
...
Open an [issue](https://github.com/Arubacloud/crossplane-provider-arubacloud/issues).
